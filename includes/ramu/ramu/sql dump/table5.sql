...
-- -----------------------------------------------------
-- Data for table `mydb`.`CouponType`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`CouponType` (`couponTypeID`, `typeName`) VALUES (1, 'flatoff');
INSERT INTO `mydb`.`CouponType` (`couponTypeID`, `typeName`) VALUES (2, 'percentage');

COMMIT;


-- -----------------------------------------------------
-- Data for table `mydb`.`CouponGroup`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`CouponGroup` (`couponGroupID`, `CouponMetaName`) VALUES (1, 'Manufacturer');
INSERT INTO `mydb`.`CouponGroup` (`couponGroupID`, `CouponMetaName`) VALUES (2, 'Category');
INSERT INTO `mydb`.`CouponGroup` (`couponGroupID`, `CouponMetaName`) VALUES (3, 'Seller');
INSERT INTO `mydb`.`CouponGroup` (`couponGroupID`, `CouponMetaName`) VALUES (4, 'Product');

COMMIT;


-- -----------------------------------------------------
-- Data for table `mydb`.`Coupons`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`Coupons` (`couponCode`, `CouponType_couponTypeID`, `CouponGroup_couponGroupID`, `couponGroupMetaValue`, `couponStartDate`, `couponExpiryDate`, `minAmount`, `maxDiscount`, `couponMaxUsage`) VALUES ('JHBSDB', 2, 1, 1, '2013-28-10', '2013-28-11', 500, 1500, 1);
...
-- -----------------------------------------------------
-- Data for table `mydb`.`shipping`
-- -----------------------------------------------------
START TRANSACTION;
USE `mydb`;
INSERT INTO `mydb`.`shipping` (`Orders_orderID`, `trackingID`, `shippingCompany_shippingCompanyID`, `deliveryDate`) VALUES (1, '45MK43', 1, '2013-11-06');
INSERT INTO `mydb`.`shipping` (`Orders_orderID`, `trackingID`, `shippingCompany_shippingCompanyID`, `deliveryDate`) VALUES (2, ' FJ3432', 2, '2013-11-06');
INSERT INTO `mydb`.`shipping` (`Orders_orderID`, `trackingID`, `shippingCompany_shippingCompanyID`, `deliveryDate`) VALUES (3, 'NJFK32', 3, '2013-11-06');
